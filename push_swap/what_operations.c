...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/08/15 20:23:35 by prawney           #+#    #+#             */
/*   Updated: 2019/08/19 19:55:37 by prawney          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	operations_1(t_stack *stack_a, t_stack *stack_b, int index)
{
	int repeat;
	int ra;
...
void	operations_2(t_stack *stack_a, t_stack *stack_b, int index)
{
	int repeat;
	int rra;
	int rrb;
...
void	operations_3(t_stack *stack_a, t_stack *stack_b, int index)
{
	int rra;
...
void	operations_4(t_stack *stack_a, t_stack *stack_b, int index)
{
	int ra;
	int rrb;
